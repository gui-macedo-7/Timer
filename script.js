...
function clockRunning()
{
    ...
    var timeElapesed = new Date(currentTime - timeBegan - stoppedDuration);

    var minutes = timeElapesed.getUTCMinutes();
    var seconds = timeElapesed.getUTCSeconds();
    var milliseconds = timeElapesed.getUTCMilliseconds();
